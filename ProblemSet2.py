...
def problem2_4():
    ...
    random.seed(70)
    for i in range(0,10):
        print(random.uniform(30,35), end=" ")
...
def problem2_6():
    ...
    for i in range(0,100):
        dice_roller1.append(random.randint(1,6))
        dice_roller2.append(random.randint(1,6))
    for k in range(0,100):
        sum_=dice_roller1[k]+dice_roller2[k]
        print(sum_)
